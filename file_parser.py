...
# Set Tesseract path if it's not in PATH (Common Windows installation path)
# If Tesseract is in PATH, this line can be removed or commented out.
pytesseract.pytesseract.tesseract_cmd = r'D:\projectpribadi\tesseract.exe'

# Set TESSDATA_PREFIX to point to tessdata directory
os.environ['TESSDATA_PREFIX'] = r'D:\projectpribadi\tessdata'

# Poppler Path (User provided)
